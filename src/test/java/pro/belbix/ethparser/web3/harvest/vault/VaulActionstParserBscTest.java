...
public class VaulActionstParserBscTest {
  ...
  void test_PC_BUSD_BNB_after_migration() throws Exception {
    ...
    assertModel(HarvestDTO.builder()
        ...
        .confirmed(1)
        .methodName("Withdraw")
        .owner("0xeda1185947a43b97f45ec8937ff870c8d86be3b6")
        .amount(7.805141177539707)
        .vault("V_PCS_WBNB_BUSD")
        .lastUsdTvl(84050.0)
        .sharePrice(1.1900341364533231)
        .usdAmount(493L)
        .lpStat(
            "{\"coin1\":\"WBNB\",\"coin1Address\":\"0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c\",\"coin2\":\"BUSD\",\"coin2Address\":\"0xe9e7cea3dedca5984780bafc599bd69add087d56\",\"amount1\":62.837362266710564,\"amount2\":42025.004143166894,\"price1\":668.790073727053,\"price2\":1.0}")
        .ownerBalance(0.)
        .ownerBalanceUsd(0.)
        .migrated(false)
        .underlyingPrice(null)
        .ownerCount(0)
        .lastTvl(1585.026029054272)
        .profit(null)
        .profitUsd(null)
        .totalAmount(null)
        .build(), harvestDTO);
