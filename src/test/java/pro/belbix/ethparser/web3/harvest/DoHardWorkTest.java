...
public class DoHardWorkTest {
    ...
    public void parseUSDC_V0() {
        assertOnBlock(10772976, "-0,000405", "-170,167614");
    }
    ...
    private void assertOnBlock(int onBlock,
        ...
        assertNotNull(dto);
        assertEquals(sharePrice, String.format("%f", dto.getShareChange()));
        assertEquals(sharePriceUsd, String.format("%f", dto.getShareChangeUsd()));
    }
