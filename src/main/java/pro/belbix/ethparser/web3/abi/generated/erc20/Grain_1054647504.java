...
public class Grain_1054647504 extends Contract {
    public static final String BINARY = "Bin file was not provided";

    public static final String FUNC_MAX_AMOUNT = "MAX_AMOUNT";
    ...
    @Deprecated
    protected Grain_1054647504(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected Grain_1054647504(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected Grain_1054647504(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected Grain_1054647504(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<BigInteger> call_MAX_AMOUNT() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_MAX_AMOUNT, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send_MAX_AMOUNT() {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_addMinter(String _minter) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_ADDMINTER, 
    ...
    public RemoteFunctionCall<BigInteger> call_cap() {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_cap() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_CAP, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    @Deprecated
    public static Grain_1054647504 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new Grain_1054647504(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Grain_1054647504 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Grain_1054647504(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Grain_1054647504 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new Grain_1054647504(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Grain_1054647504 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new Grain_1054647504(contractAddress, web3j, transactionManager, contractGasProvider);
    }
