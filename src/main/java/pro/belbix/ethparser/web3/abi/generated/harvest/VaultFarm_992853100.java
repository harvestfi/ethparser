...
public class VaultFarm_992853100 extends Contract {
    ...
    public static final String FUNC_AUTOSTAKEUPONWITHDRAWAL = "autoStakeUponWithdrawal";
    ...
    public static final String FUNC_SETAUTOSTAKEUPONWITHDRAWAL = "setAutoStakeUponWithdrawal";
    ...
    @Deprecated
    protected VaultFarm_992853100(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected VaultFarm_992853100(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected VaultFarm_992853100(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected VaultFarm_992853100(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<Boolean> call_autoStakeUponWithdrawal() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_AUTOSTAKEUPONWITHDRAWAL, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeRemoteCallSingleValueReturn(function, Boolean.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send_autoStakeUponWithdrawal() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_AUTOSTAKEUPONWITHDRAWAL, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> send_setAutoStakeUponWithdrawal(Boolean _value) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETAUTOSTAKEUPONWITHDRAWAL, 
    ...
    @Deprecated
    public static VaultFarm_992853100 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new VaultFarm_992853100(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static VaultFarm_992853100 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new VaultFarm_992853100(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static VaultFarm_992853100 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new VaultFarm_992853100(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static VaultFarm_992853100 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new VaultFarm_992853100(contractAddress, web3j, transactionManager, contractGasProvider);
    }
