...
public class WrappedmAMZN_934526858 extends Contract {
    ...
    @Deprecated
    protected WrappedmAMZN_934526858(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected WrappedmAMZN_934526858(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected WrappedmAMZN_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected WrappedmAMZN_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static WrappedmAMZN_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmAMZN_934526858(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static WrappedmAMZN_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmAMZN_934526858(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static WrappedmAMZN_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new WrappedmAMZN_934526858(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static WrappedmAMZN_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new WrappedmAMZN_934526858(contractAddress, web3j, transactionManager, contractGasProvider);
    }
