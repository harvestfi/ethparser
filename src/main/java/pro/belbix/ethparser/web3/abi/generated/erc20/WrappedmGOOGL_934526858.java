...
public class WrappedmGOOGL_934526858 extends Contract {
    ...
    @Deprecated
    protected WrappedmGOOGL_934526858(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected WrappedmGOOGL_934526858(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected WrappedmGOOGL_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected WrappedmGOOGL_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_burn(BigInteger amount, byte[] to) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_BURN, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(amount), 
                new org.web3j.abi.datatypes.generated.Bytes32(to)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static WrappedmGOOGL_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmGOOGL_934526858(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static WrappedmGOOGL_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmGOOGL_934526858(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static WrappedmGOOGL_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new WrappedmGOOGL_934526858(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static WrappedmGOOGL_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new WrappedmGOOGL_934526858(contractAddress, web3j, transactionManager, contractGasProvider);
    }
