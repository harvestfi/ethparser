...
public class ExclusiveRewardPool_0785112466 extends Contract {
    ...
    public static final String FUNC_EXCLUSIVEADDRESS = "exclusiveAddress";
    ...
    public static final String FUNC_INITEXCLUSIVE = "initExclusive";
    ...
    @Deprecated
    protected ExclusiveRewardPool_0785112466(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected ExclusiveRewardPool_0785112466(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected ExclusiveRewardPool_0785112466(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected ExclusiveRewardPool_0785112466(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<String> call_exclusiveAddress() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_EXCLUSIVEADDRESS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send_exclusiveAddress() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_EXCLUSIVEADDRESS, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> send_initExclusive(String _exclusive) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_INITEXCLUSIVE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _exclusive)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static ExclusiveRewardPool_0785112466 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ExclusiveRewardPool_0785112466(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ExclusiveRewardPool_0785112466 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ExclusiveRewardPool_0785112466(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static ExclusiveRewardPool_0785112466 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ExclusiveRewardPool_0785112466(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static ExclusiveRewardPool_0785112466 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ExclusiveRewardPool_0785112466(contractAddress, web3j, transactionManager, contractGasProvider);
    }
