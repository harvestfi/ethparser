...
public class NoMintRewardPool_0603942548 extends Contract {
    public static final String BINARY = "Bin file was not provided";

    public static final String FUNC_BALANCEOF = "balanceOf";

    public static final String FUNC_CANMIGRATE = "canMigrate";
    ...
    public static final String FUNC_MIGRATIONSTRATEGY = "migrationStrategy";
    ...
    public static final String FUNC_PULLFROMSTRATEGY = "pullFromStrategy";
    ...
    public static final String FUNC_SETCANMIGRATE = "setCanMigrate";
    ...
    public static final String FUNC_SOURCEVAULT = "sourceVault";
    ...
    @Deprecated
    protected NoMintRewardPool_0603942548(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected NoMintRewardPool_0603942548(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected NoMintRewardPool_0603942548(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected NoMintRewardPool_0603942548(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public List<MigratedEventResponse> getMigratedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.legacyShare = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.newShare = (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public RemoteFunctionCall<Boolean> call_canMigrate() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_CANMIGRATE, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeRemoteCallSingleValueReturn(function, Boolean.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send_canMigrate() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_CANMIGRATE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> send_migrate() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_MIGRATE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call_migrationStrategy() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_MIGRATIONSTRATEGY, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send_migrationStrategy() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_MIGRATIONSTRATEGY, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> send_pullFromStrategy() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_PULLFROMSTRATEGY, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<String> call_rewardDistribution() {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_rewardDistribution() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> send_setCanMigrate(Boolean _canMigrate) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETCANMIGRATE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Bool(_canMigrate)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<String> call_sourceVault() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SOURCEVAULT, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send_sourceVault() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SOURCEVAULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    @Deprecated
    public static NoMintRewardPool_0603942548 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new NoMintRewardPool_0603942548(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static NoMintRewardPool_0603942548 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new NoMintRewardPool_0603942548(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static NoMintRewardPool_0603942548 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new NoMintRewardPool_0603942548(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static NoMintRewardPool_0603942548 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new NoMintRewardPool_0603942548(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static class MigratedEventResponse extends BaseEventResponse {
        public String account;

        public BigInteger legacyShare;

        public BigInteger newShare;
    }
