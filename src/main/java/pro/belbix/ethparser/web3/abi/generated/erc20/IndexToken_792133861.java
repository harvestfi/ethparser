...
public class IndexToken_792133861 extends Contract {
    ...
    @Deprecated
    protected IndexToken_792133861(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected IndexToken_792133861(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected IndexToken_792133861(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected IndexToken_792133861(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<BigInteger> call_allowance(String account, String spender) {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_allowance(String account, String spender) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_ALLOWANCE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, account), 
                new org.web3j.abi.datatypes.Address(160, spender)), 
    ...
    public RemoteFunctionCall<TransactionReceipt> send_approve(String spender, BigInteger rawAmount) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_APPROVE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, spender), 
                new org.web3j.abi.datatypes.generated.Uint256(rawAmount)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Tuple2<BigInteger, BigInteger>> call_checkpoints(String param0, BigInteger param1) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_CHECKPOINTS, 
                ...
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint32>() {}, new TypeReference<Uint96>() {}));
    ...
    public RemoteFunctionCall<String> call_delegates(String param0) {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_delegates(String param0) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_DELEGATES, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, param0)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> send_transfer(String dst, BigInteger rawAmount) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_TRANSFER, 
    ...
    public RemoteFunctionCall<TransactionReceipt> send_transferFrom(String src, String dst, BigInteger rawAmount) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_TRANSFERFROM, 
    ...
    @Deprecated
    public static IndexToken_792133861 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IndexToken_792133861(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IndexToken_792133861 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IndexToken_792133861(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IndexToken_792133861 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IndexToken_792133861(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IndexToken_792133861 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IndexToken_792133861(contractAddress, web3j, transactionManager, contractGasProvider);
    }
