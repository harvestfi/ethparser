...
public class FiatTokenProxy_1270266386 extends Contract {
    ...
    @Deprecated
    protected FiatTokenProxy_1270266386(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected FiatTokenProxy_1270266386(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected FiatTokenProxy_1270266386(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected FiatTokenProxy_1270266386(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<String> call_admin() {
    ...
    @Deprecated
    public static FiatTokenProxy_1270266386 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new FiatTokenProxy_1270266386(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static FiatTokenProxy_1270266386 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new FiatTokenProxy_1270266386(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static FiatTokenProxy_1270266386 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new FiatTokenProxy_1270266386(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static FiatTokenProxy_1270266386 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new FiatTokenProxy_1270266386(contractAddress, web3j, transactionManager, contractGasProvider);
    }
