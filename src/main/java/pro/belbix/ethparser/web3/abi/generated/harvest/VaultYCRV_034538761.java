...
public class VaultYCRV_034538761 extends Contract {
    ...
    @Deprecated
    protected VaultYCRV_034538761(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected VaultYCRV_034538761(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected VaultYCRV_034538761(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected VaultYCRV_034538761(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static VaultYCRV_034538761 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new VaultYCRV_034538761(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static VaultYCRV_034538761 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new VaultYCRV_034538761(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static VaultYCRV_034538761 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new VaultYCRV_034538761(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static VaultYCRV_034538761 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new VaultYCRV_034538761(contractAddress, web3j, transactionManager, contractGasProvider);
    }
