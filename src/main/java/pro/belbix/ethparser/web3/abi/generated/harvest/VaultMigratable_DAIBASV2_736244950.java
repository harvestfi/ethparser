...
public class VaultMigratable_DAIBASV2_736244950 extends Contract {
    public static final String BINARY = "Bin file was not provided";

    public static final String FUNC___BAS = "__bas";

    public static final String FUNC___BAS_SWAP = "__bas_swap";

    public static final String FUNC___BASV2 = "__basv2";

    public static final String FUNC___DAI = "__dai";

    public static final String FUNC___DAI_BAS = "__dai_bas";

    public static final String FUNC___DAI_BASV2 = "__dai_basv2";

    public static final String FUNC___DAI_BASV2_STRATEGY = "__dai_basv2_strategy";

    public static final String FUNC___GOVERNANCE = "__governance";

    public static final String FUNC___UNISWAP = "__uniswap";
    ...
    @Deprecated
    protected VaultMigratable_DAIBASV2_736244950(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected VaultMigratable_DAIBASV2_736244950(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected VaultMigratable_DAIBASV2_736244950(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected VaultMigratable_DAIBASV2_736244950(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public List<LiquidityProvidedEventResponse> getLiquidityProvidedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse.basV2Contributed = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.daiContributed = (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
            typedResponse.v2Liquidity = (BigInteger) eventValues.getNonIndexedValues().get(2).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<LiquidityRemovedEventResponse> getLiquidityRemovedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.amountDai = (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
            typedResponse.amountBas = (BigInteger) eventValues.getNonIndexedValues().get(2).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<MigratedEventResponse> getMigratedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse.v1Liquidity = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.v2Liquidity = (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public RemoteFunctionCall<String> call___bas() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___BAS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___bas() {
    ...
    public RemoteFunctionCall<String> call___bas_swap() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___BAS_SWAP, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___bas_swap() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___BAS_SWAP, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call___basv2() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___BASV2, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___basv2() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___BASV2, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call___dai() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___DAI, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___dai() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___DAI, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call___dai_bas() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___DAI_BAS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___dai_bas() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___DAI_BAS, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call___dai_basv2() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___DAI_BASV2, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___dai_basv2() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___DAI_BASV2, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call___dai_basv2_strategy() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___DAI_BASV2_STRATEGY, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___dai_basv2_strategy() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___DAI_BASV2_STRATEGY, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<String> call___governance() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___GOVERNANCE, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___governance() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___GOVERNANCE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> call___uniswap() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC___UNISWAP, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<TransactionReceipt> send___uniswap() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC___UNISWAP, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> send_migrateUnderlying(BigInteger minDaiOut, BigInteger minBasOut, BigInteger minBasV2Contribution, BigInteger minDaiContribution) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_MIGRATEUNDERLYING, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(minDaiOut), 
                new org.web3j.abi.datatypes.generated.Uint256(minBasOut), 
                new org.web3j.abi.datatypes.generated.Uint256(minBasV2Contribution), 
                new org.web3j.abi.datatypes.generated.Uint256(minDaiContribution)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static VaultMigratable_DAIBASV2_736244950 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new VaultMigratable_DAIBASV2_736244950(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static VaultMigratable_DAIBASV2_736244950 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new VaultMigratable_DAIBASV2_736244950(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static VaultMigratable_DAIBASV2_736244950 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new VaultMigratable_DAIBASV2_736244950(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static VaultMigratable_DAIBASV2_736244950 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new VaultMigratable_DAIBASV2_736244950(contractAddress, web3j, transactionManager, contractGasProvider);
    }
    ...
    public static class LiquidityProvidedEventResponse extends BaseEventResponse {
        public BigInteger basV2Contributed;

        public BigInteger daiContributed;
    ...
    public static class LiquidityRemovedEventResponse extends BaseEventResponse {
        ...
        public BigInteger amountDai;

        public BigInteger amountBas;
    }
