...
public class WrappedmTWTR_934526858 extends Contract {
    ...
    @Deprecated
    protected WrappedmTWTR_934526858(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected WrappedmTWTR_934526858(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected WrappedmTWTR_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected WrappedmTWTR_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static WrappedmTWTR_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmTWTR_934526858(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static WrappedmTWTR_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmTWTR_934526858(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static WrappedmTWTR_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new WrappedmTWTR_934526858(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static WrappedmTWTR_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new WrappedmTWTR_934526858(contractAddress, web3j, transactionManager, contractGasProvider);
    }
