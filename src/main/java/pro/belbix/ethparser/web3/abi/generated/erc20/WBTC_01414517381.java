...
public class WBTC_01414517381 extends Contract {
    ...
    @Deprecated
    protected WBTC_01414517381(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected WBTC_01414517381(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected WBTC_01414517381(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected WBTC_01414517381(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public RemoteFunctionCall<Boolean> call_mintingFinished() {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_mintingFinished() {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_reclaimToken(String _token) {
        final Function function = new Function(
                FUNC_RECLAIMTOKEN, 
    ...
    public RemoteFunctionCall<TransactionReceipt> send_burn(BigInteger value) {
        final Function function = new Function(
                FUNC_BURN, 
    ...
    public RemoteFunctionCall<TransactionReceipt> send_finishMinting() {
        final Function function = new Function(
                FUNC_FINISHMINTING, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    @Deprecated
    public static WBTC_01414517381 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new WBTC_01414517381(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static WBTC_01414517381 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new WBTC_01414517381(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static WBTC_01414517381 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new WBTC_01414517381(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static WBTC_01414517381 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new WBTC_01414517381(contractAddress, web3j, transactionManager, contractGasProvider);
    }
