...
public class OneInch_1350894887 extends Contract {
    ...
    @Deprecated
    protected OneInch_1350894887(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected OneInch_1350894887(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected OneInch_1350894887(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected OneInch_1350894887(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<BigInteger> call_nonces(String owner) {
    ...
    public RemoteFunctionCall<TransactionReceipt> send_nonces(String owner) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_NONCES, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, owner)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    @Deprecated
    public static OneInch_1350894887 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OneInch_1350894887(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OneInch_1350894887 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OneInch_1350894887(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OneInch_1350894887 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OneInch_1350894887(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OneInch_1350894887 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OneInch_1350894887(contractAddress, web3j, transactionManager, contractGasProvider);
    }
