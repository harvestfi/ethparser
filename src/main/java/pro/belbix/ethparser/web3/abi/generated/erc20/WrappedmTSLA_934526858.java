...
public class WrappedmTSLA_934526858 extends Contract {
    ...
    @Deprecated
    protected WrappedmTSLA_934526858(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected WrappedmTSLA_934526858(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected WrappedmTSLA_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected WrappedmTSLA_934526858(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static WrappedmTSLA_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmTSLA_934526858(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static WrappedmTSLA_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new WrappedmTSLA_934526858(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static WrappedmTSLA_934526858 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new WrappedmTSLA_934526858(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static WrappedmTSLA_934526858 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new WrappedmTSLA_934526858(contractAddress, web3j, transactionManager, contractGasProvider);
    }
