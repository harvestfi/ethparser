...
public class ContractUtils {
  ...
  public static boolean isFullParsableLpAddressAndDate(String address, BigInteger date,
      String network) {
    return FULL_PARSABLE_UNI_PAIRS.get(network).containsKey(address.toLowerCase())
        && date.intValue() > FULL_PARSABLE_UNI_PAIRS.get(network).get(address.toLowerCase());
  }
}
