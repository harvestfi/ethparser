...
class UniPairAddresses {
    ...
    static final List<LpContract> UNI_PAIRS = createLpContracts(
        ...
        new LpContract(11508188, "SUSHI_LP_ETH_UST", "UST", "0x8B00eE8606CC70c2dce68dea0CEfe632CCA0fB7b"),
        new LpContract(11380589, "UNI_LP_MNFLX_UST", "MNFLX", "0xC99A74145682C4b4A6e9fa55d559eb49A6884F75"),
        new LpContract(11380726, "UNI_LP_MTWTR_UST", "MTWTR", "0x34856be886A2dBa5F7c38c4df7FD86869aB08040")
    );
}
